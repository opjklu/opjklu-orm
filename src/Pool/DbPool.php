 ...
 */
namespace Swoft\Orm\Pool;

use Swoft\App;
use Swoft\Bean\Annotation\Inject;
use Swoft\Bean\Annotation\Pool;
use Swoft\Orm\Bean\Collector\ConnectionCollector;
use Swoft\Orm\Driver\DriverType;
use Swoft\Orm\Exception\DbException;
use Swoft\Orm\Pool\Config\DbPoolConfig;
...
class DbPool extends ConnectionPool
{
     ...
     *
     * @return string
     * @throws \Swoft\Orm\Exception\DbException
     */
