...
abstract class AbstractGenerator
{
    ...
    protected $uses = [
        'Swoft\Orm\Model',
        'Swoft\Orm\Bean\Annotation\Column',
        'Swoft\Orm\Bean\Annotation\Entity',
        'Swoft\Orm\Bean\Annotation\Id',
        'Swoft\Orm\Bean\Annotation\Required',
        'Swoft\Orm\Bean\Annotation\Table',
        'Swoft\Orm\Types'
    ];
